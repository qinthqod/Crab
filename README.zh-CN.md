...
[**下载 Crab v0.2.1 Apple Silicon 版 →**](https://github.com/qinthqod/Crab/releases/download/v0.2.1/Crab-0.2.1-macOS-arm64.dmg)

Crab 需要 Apple Silicon 与 macOS 14 或更高版本。安装前可下载
[SHA-256 校验文件](https://github.com/qinthqod/Crab/releases/download/v0.2.1/SHA256SUMS.txt)。
...
- macOS 14 或更高版本
- 可下载的 v0.2.1 测试版适用于 Apple Silicon
- Intel Mac 可使用兼容的 Swift 6 工具链从源码构建
- 从源码构建需要 Swift 6 工具链

## 安装公开测试版

下载 [`Crab-0.2.1-macOS-arm64.dmg`](https://github.com/qinthqod/Crab/releases/download/v0.2.1/Crab-0.2.1-macOS-arm64.dmg)
和 [`SHA256SUMS.txt`](https://github.com/qinthqod/Crab/releases/download/v0.2.1/SHA256SUMS.txt)，
